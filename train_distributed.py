...
parser.add_argument("--augment_mode", default="identity", choices=["identity", "RPG", "eventdrop", "NDA"])
...
parser.add_argument("--representation", default="VoxelGrid", choices=["VoxelGrid", "EST"])
parser.add_argument("--classifier", default="resnet34", choices=["vgg19", "resnet34", "resnet18"])
...
def distributed_train(rank):
    ...
    event_augment = EventAugment(args.event_resolution, model.module, l_mags=args.l_mags,
    ...
    training_loader = Loader(train_ds, args, device, distributed=args.train_distributed, batch_size=args.batch_size_per_gpu)
